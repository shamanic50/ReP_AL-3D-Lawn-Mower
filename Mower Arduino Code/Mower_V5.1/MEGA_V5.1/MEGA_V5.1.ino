...
/************************************************************************************
        ReP_AL Mower Project V5.1
     ==========================================

Fixed Sonar in refind wire mode.
...
void setup() {
  ...
  */
  ...
  //Set_Time_On_RTC();            // uncomment to set the time. Go to the funtion to set the times and dates
...
void loop() {
  ...
  ***********************************************************************/
  ...
  Serial.print("Mower Docked Status = ");
  ...
  Serial.print("Loops completed: ");                              // Keeping track of the program health in the serial monitor
  Serial.println(MowerMotionStatus);                              // In Setup - first loop Motion Mower is set to 2
  //radio.write(&MowerMotionStatus, sizeof(MowerMotionStatus));
  ...
  // Compass Heading
  if (Compass_Mode == 1) Get_Compass_Reading();                                   // Gets the compass direction of the mower

  /* CHECK ALL SENSORS IF MOWER IS NOT DOCKED
  ************************************************************************************/
  if (Mower_Docked == 0) {                                                        // Sensors are not ran if docked.
    delay(2);
    TestforBatteryVoltage();                                 // Battery Level Check;
    delay(2);
  ...
  /*Checks for the activation of Alarms which set the Mower going
   **************************************************************************/
